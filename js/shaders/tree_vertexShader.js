...
//Funksjoner: cnoise(), permute(), taylorInvSqrt() og fade() er tatt fra: https://gist.github.com/patriciogonzalezvivo/670c22f3966e662d2f83
...
void main () {
    ...
    float displacement = cnoise(position * time );
    if(position.y < 1.0) {
        displacement = 1.0;
    }
